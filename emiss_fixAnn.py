'''
 ANN with 1 hidden layer and 4 nodes
...
n_split  = 1000 # 500  #100 #10  
n_sample = 30   # number of interval selection fullfilling the n_tsw conditions

name   = 'fixAnn'    # name of saved figures
dirnam = 'fixAnn_LR_001/'  # Directory    
name   = dirnam + name
...
model = MLPRegressor(hidden_layer_sizes=(4,), activation='relu', solver='adam', learning_rate_init=0.001, 
